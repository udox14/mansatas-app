      ...
      <DialogContent className="sm:max-w-md rounded-xl">
        <DialogHeader className="border-b pb-3">
          <DialogTitle className="text-sm font-semibold text-slate-800 dark:text-slate-200 dark:text-slate-100 flex items-center gap-2">
            <BookOpen className="h-4 w-4 text-slate-600 dark:text-slate-400 dark:text-slate-300 dark:text-slate-600" />
        ...
        <form action={formAction} className="space-y-3 pt-1">
          ...
          <div className="space-y-1.5">
            <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300 dark:text-slate-600">Nama Pelanggaran <span className="text-rose-500">*</span></Label>
            <Input
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300 dark:text-slate-600">Kategori <span className="text-rose-500">*</span></Label>
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300 dark:text-slate-600">Bobot Poin <span className="text-rose-500">*</span></Label>
              <Input
                type="number" name="poin" min="1" max="100"
                defaultValue={editData?.poin || 5}
                required
                className="h-8 text-sm rounded-md bg-slate-50 dark:bg-slate-800 font-bold text-rose-600"
              />
            </div>
          </div>
