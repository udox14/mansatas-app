          ...
          <form action={handleFormAction} className="p-4 space-y-4">
            ...
            <Tabs defaultValue="utama" className="w-full">
              ...
              <TabsContent value="utama" className="space-y-3 mt-3 bg-surface p-3 rounded-lg border border-surface">
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">NISN</Label>
                    <Input name="nisn" defaultValue={siswa.nisn} required className="h-8 text-sm rounded-md bg-surface-2" />
                  </div>
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">NIS Lokal</Label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Jenis Kelamin</Label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Tempat Lahir</Label>
                    <Input name="tempat_lahir" defaultValue={siswa.tempat_lahir} className="h-8 text-sm rounded-md bg-surface-2" />
                  </div>
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Tanggal Lahir</Label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Status Siswa</Label>
                ...
                <div className="space-y-1.5">
                  <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Tahun Masuk (Angkatan)</Label>
              ...
              <TabsContent value="alamat" className="space-y-3 mt-3 bg-surface p-3 rounded-lg border border-surface">
                <div className="space-y-1.5">
                  <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Status Domisili / Pesantren</Label>
                ...
                <div className="space-y-1.5">
                  <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Alamat Lengkap</Label>
                  <Input name="alamat_lengkap" defaultValue={siswa.alamat_lengkap} className="h-8 text-sm rounded-md bg-surface-2" />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Desa / Kelurahan</Label>
                    <Input name="desa_kelurahan" defaultValue={siswa.desa_kelurahan} className="h-8 text-sm rounded-md bg-surface-2" />
                  </div>
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Kecamatan</Label>
                    <Input name="kecamatan" defaultValue={siswa.kecamatan} className="h-8 text-sm rounded-md bg-surface-2" />
                  </div>
                </div>
                <div className="space-y-1.5">
                  <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">No. WhatsApp</Label>
              ...
              <TabsContent value="ortu" className="space-y-3 mt-3 bg-surface p-3 rounded-lg border border-surface">
                <div className="space-y-1.5">
                  <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Nomor KK</Label>
                ...
                <div className="border border-surface p-3 rounded-lg bg-surface-2 space-y-3">
                  <p className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Data Ayah</p>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                ...
                <div className="border border-surface p-3 rounded-lg bg-surface-2 space-y-3">
                  <p className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300">Data Ibu</p>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
