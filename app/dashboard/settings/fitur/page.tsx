...
export default async function FiturPage() {
  ...
  const { matrix, permissions, roles, featureLabels, sidebarTemplate } = await getRoleFeatureMatrix()
  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-500 pb-12">
      ...
      <FiturClient
        ...
        initialRoles={roles}
        initialFeatureLabels={featureLabels}
        initialSidebarTemplate={sidebarTemplate}
      />
    </div>
  )
}
