...
export const metadata = { title: 'Manajemen Fitur - MANSATAS App' }
...
export default async function FiturPage() {
  ...
  const { matrix, permissions, roles, featureLabels } = await getRoleFeatureMatrix()
  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-500 pb-12">
      ...
      />
      <FiturClient initialMatrix={matrix} initialPermissions={permissions} initialRoles={roles} initialFeatureLabels={featureLabels} />
    </div>
  )
}
