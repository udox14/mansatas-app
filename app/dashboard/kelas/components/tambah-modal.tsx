      ...
      <DialogContent className="sm:max-w-md rounded-xl">
        <DialogHeader className="border-b pb-3">
          <DialogTitle className="text-sm font-semibold text-slate-800 dark:text-slate-200 dark:text-slate-100 flex items-center gap-2">
            <PlusCircle className="h-4 w-4 text-slate-600 dark:text-slate-400 dark:text-slate-300 dark:text-slate-600" /> Buat Wadah Kelas Baru
          </DialogTitle>
        </DialogHeader>
        ...
        <form action={formAction} className="space-y-3 pt-1">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input name="nomor_kelas" placeholder="Contoh: 1, 2, A" required className="h-8 text-sm rounded-md bg-slate-50 dark:bg-slate-800" />
            </div>
            <div className="space-y-1.5">
              ...
              <Input name="kapasitas" type="number" defaultValue="36" required className="h-8 text-sm rounded-md bg-slate-50 dark:bg-slate-800 font-bold" />
            </div>
          </div>

          <div className="space-y-1.5">
            <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-300 dark:text-slate-600">Wali Kelas <span className="text-slate-400 dark:text-slate-500 font-normal">(opsional)</span></Label>
            <Select name="wali_kelas_id">
              <SelectTrigger className="h-8 text-xs rounded-md bg-slate-50 dark:bg-slate-800"><SelectValue placeholder="Bisa dipilih nanti..." /></SelectTrigger>
